...
class LaserMapping {
   public:
    ...
    /// init with ros
    bool InitROS(const rclcpp::Node::SharedPtr &nh);

    /// init without ros
    void SetOffline(bool value) { run_in_offline_ = value; }
    ...
    void PublishOdometryBody(const rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr &pub_odom_body_mapped);
   ...
   private:
    ...
    void SubAndPubToROS(const rclcpp::Node::SharedPtr &nh);

    bool LoadParams(const rclcpp::Node::SharedPtr &nh);
   ...
   private:
    ...
    std::vector<uint8_t> point_selected_surf_;           // selected points
    ...
    rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pub_odom_body_mapped_;
    ...
    nav_msgs::msg::Odometry odom_body_mapped_;
